...
public class UserRegisterCommandParser implements Parser<UserRegisterCommand> {
    ...
    public UserRegisterCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, CliSyntax.PREFIX_USER, CliSyntax.PREFIX_PASSWORD, CliSyntax.PREFIX_PASSWORD_CONFIRM,
                CliSyntax.PREFIX_SECRET_QUESTION, CliSyntax.PREFIX_ANSWER)
        ...
        String secretQuestion = ParserUtil.parseSecretQuestion(argMultimap.getValue(CliSyntax.PREFIX_SECRET_QUESTION).get());
