...
public class UserRegisterCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        CommandParserTestUtil.assertParseSuccess(parser, CommandTestUtil.PREAMBLE_WHITESPACE + CommandTestUtil.USERNAME_DESC_AARON
        ...
        CommandParserTestUtil.assertParseSuccess(parser, CommandTestUtil.PREAMBLE_WHITESPACE + CommandTestUtil.USERNAME_DESC_FOODBEAR
    ...
    public void parse_missingFields_failure() {
        ...
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.USERNAME_DESC_AARON + CommandTestUtil.PASSWORD_DESC_AARON
    ...
    public void parse_repeatedValue_failure() {
        String validExpectedUserString = CommandTestUtil.USERNAME_DESC_AARON + CommandTestUtil.PASSWORD_DESC_AARON
                + CommandTestUtil.PASSWORD_CONFIRM_DESC_AARON + CommandTestUtil.SECRET_QUESTION_DESC_AARON + CommandTestUtil.ANSWER_DESC_AARON;

        // multiple usernames
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.USERNAME_DESC_AARON + validExpectedUserString,
                Messages.getErrorMessageForDuplicatePrefixes(CliSyntax.PREFIX_USER));

        // multiple password
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.PASSWORD_DESC_AARON + validExpectedUserString,
                Messages.getErrorMessageForDuplicatePrefixes(CliSyntax.PREFIX_PASSWORD));

        // multiple fields repeated
        CommandParserTestUtil.assertParseFailure(parser,
                validExpectedUserString + CommandTestUtil.USERNAME_DESC_AARON + CommandTestUtil.PASSWORD_DESC_AARON,
                Messages.getErrorMessageForDuplicatePrefixes(CliSyntax.PREFIX_USER, CliSyntax.PREFIX_PASSWORD));

        // multiple confirm password
        CommandParserTestUtil.assertParseFailure(parser, validExpectedUserString + CommandTestUtil.PASSWORD_CONFIRM_DESC_AARON,
                Messages.getErrorMessageForDuplicatePrefixes(CliSyntax.PREFIX_PASSWORD_CONFIRM));

        // invalid value followed by valid value

        // invalid username
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.INVALID_USERNAME_DESC + validExpectedUserString,
                Messages.getErrorMessageForDuplicatePrefixes(CliSyntax.PREFIX_USER));

        // invalid password
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.INVALID_PASSWORD_DESC + validExpectedUserString,
                Messages.getErrorMessageForDuplicatePrefixes(CliSyntax.PREFIX_PASSWORD));

        // valid value followed by invalid value

        CommandParserTestUtil.assertParseFailure(parser, validExpectedUserString + CommandTestUtil.INVALID_USERNAME_DESC,
                Messages.getErrorMessageForDuplicatePrefixes(CliSyntax.PREFIX_USER));

        CommandParserTestUtil.assertParseFailure(parser, validExpectedUserString + CommandTestUtil.INVALID_PASSWORD_DESC,
                Messages.getErrorMessageForDuplicatePrefixes(CliSyntax.PREFIX_PASSWORD));
    }
    ...
    public void parse_passwordMismatch_failure() {
        ...
        // password mismatch
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.USERNAME_DESC_AARON + CommandTestUtil.PASSWORD_DESC_AARON
                        + CommandTestUtil.PASSWORD_CONFIRM_DESC_FOODBEAR + CommandTestUtil.SECRET_QUESTION_DESC_AARON + CommandTestUtil.ANSWER_DESC_AARON,
                expectedMessage);
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.VALID_USERNAME_AARON + CommandTestUtil.VALID_PASSWORD_AARON,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        // invalid username
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.INVALID_USERNAME_DESC + CommandTestUtil.PASSWORD_DESC_AARON
                        + CommandTestUtil.PASSWORD_CONFIRM_DESC_AARON + CommandTestUtil.SECRET_QUESTION_DESC_AARON + CommandTestUtil.ANSWER_DESC_AARON,
                Username.MESSAGE_CONSTRAINTS);

        // invalid password
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.USERNAME_DESC_AARON + CommandTestUtil.INVALID_PASSWORD_DESC
        ...
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.INVALID_USERNAME_DESC + CommandTestUtil.INVALID_PASSWORD_DESC
                        + CommandTestUtil.INVALID_PASSWORD_CONFIRM_DESC + CommandTestUtil.SECRET_QUESTION_DESC_AARON + CommandTestUtil.ANSWER_DESC_AARON,
                Username.MESSAGE_CONSTRAINTS);
