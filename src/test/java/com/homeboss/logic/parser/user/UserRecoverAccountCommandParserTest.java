...
public class UserRecoverAccountCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        CommandParserTestUtil.assertParseSuccess(parser, CommandTestUtil.PREAMBLE_WHITESPACE + CommandTestUtil.ANSWER_DESC_AARON
        ...
        CommandParserTestUtil.assertParseSuccess(parser, CommandTestUtil.PREAMBLE_WHITESPACE + CommandTestUtil.ANSWER_DESC_FOODBEAR
    ...
    public void parse_someFieldsAbsent_failure() {
        // missing answer
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.PREAMBLE_WHITESPACE + CommandTestUtil.PASSWORD_DESC_AARON
                + CommandTestUtil.PASSWORD_CONFIRM_DESC_AARON, String.format(Messages.MESSAGE_INVALID_COMMAND_FORMAT,
                UserRecoverAccountCommand.MESSAGE_USAGE));

        // missing first password
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.PREAMBLE_WHITESPACE + CommandTestUtil.ANSWER_DESC_AARON
                + CommandTestUtil.PASSWORD_CONFIRM_DESC_AARON, String.format(Messages.MESSAGE_INVALID_COMMAND_FORMAT,
                UserRecoverAccountCommand.MESSAGE_USAGE));
