...
public class UserLoginCommandParserTest {
    ...
    public void parse_repeatedValue_failure() {
        String validExpectedUserString = CommandTestUtil.USERNAME_DESC_FOODBEAR + CommandTestUtil.PASSWORD_DESC_FOODBEAR;
    ...
    public void parse_invalidValue_failure() {
        // invalid username
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.INVALID_USERNAME_DESC + CommandTestUtil.PASSWORD_DESC_AARON, Username.MESSAGE_CONSTRAINTS);

        // invalid password
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.USERNAME_DESC_AARON + CommandTestUtil.INVALID_PASSWORD_DESC, Password.MESSAGE_CONSTRAINTS);
        ...
        // non-empty preamble
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.PREAMBLE_NON_EMPTY + CommandTestUtil.USERNAME_DESC_AARON + CommandTestUtil.PASSWORD_DESC_AARON,
