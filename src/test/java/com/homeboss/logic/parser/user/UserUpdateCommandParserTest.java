...
public class UserUpdateCommandParserTest {
    ...
    public void parse_missingParts_failure() {
        ...
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.PASSWORD_CONFIRM_DESC_AARON,
                UserUpdateCommand.MESSAGE_PASSWORD_OR_CONFIRM_PASSWORD_MISSING);

        // secret question specified, but no answer
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.SECRET_QUESTION_DESC_AARON,
                UserUpdateCommand.MESSAGE_QUESTION_OR_ANSWER_MISSING);

        // answer specified, but no secret question
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.ANSWER_DESC_AARON,
                UserUpdateCommand.MESSAGE_QUESTION_OR_ANSWER_MISSING);

        // password and secret question specified, but no confirm password and answer
        // password pair is checked first
        CommandParserTestUtil.assertParseFailure(parser,
                CommandTestUtil.PASSWORD_DESC_AARON + CommandTestUtil.SECRET_QUESTION_DESC_AARON,
                UserUpdateCommand.MESSAGE_PASSWORD_OR_CONFIRM_PASSWORD_MISSING);

        // answer and confirm password specified, but no password and secret question
        // password pair is checked first
        CommandParserTestUtil.assertParseFailure(parser,
                CommandTestUtil.ANSWER_DESC_AARON + CommandTestUtil.PASSWORD_CONFIRM_DESC_AARON,
                UserUpdateCommand.MESSAGE_PASSWORD_OR_CONFIRM_PASSWORD_MISSING);
    ...
    public void parse_invalidValue_failure() {
        ...
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.INVALID_USERNAME_DESC,
                Username.MESSAGE_CONSTRAINTS); // invalid username
        CommandParserTestUtil.assertParseFailure(parser,
                CommandTestUtil.INVALID_PASSWORD_DESC + CommandTestUtil.INVALID_PASSWORD_CONFIRM_DESC,
        ...
        CommandParserTestUtil.assertParseFailure(parser,
                CommandTestUtil.USERNAME_DESC_AARON + CommandTestUtil.INVALID_PASSWORD_DESC
                        + CommandTestUtil.INVALID_PASSWORD_CONFIRM_DESC,
    ...
    public void parse_someFieldsSpecified_success() {
        String userInput =
                CommandTestUtil.USERNAME_DESC_AARON + CommandTestUtil.SECRET_QUESTION_DESC_AARON
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput =
                CommandTestUtil.USERNAME_DESC_AARON + CommandTestUtil.PASSWORD_DESC_AARON
                        + CommandTestUtil.PASSWORD_CONFIRM_DESC_AARON
                        + CommandTestUtil.USERNAME_DESC_AARON + CommandTestUtil.SECRET_QUESTION_DESC_AARON
                        + CommandTestUtil.ANSWER_DESC_AARON + CommandTestUtil.ANSWER_DESC_AARON
