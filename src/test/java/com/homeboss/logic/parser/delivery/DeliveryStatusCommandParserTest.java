...
public class DeliveryStatusCommandParserTest {
    ...
    public void parse_allFields_success() {
        ...
        CommandParserTestUtil.assertParseSuccess(parser, " 1 " + CommandTestUtil.VALID_STATUS_CREATED_VIEW,
                deliveryStatusCommand);

        // SHIPPED
        deliveryStatusCommand = new DeliveryStatusCommand(1, DeliveryStatus.SHIPPED);

        CommandParserTestUtil.assertParseSuccess(parser, " 1 " + CommandTestUtil.VALID_STATUS_SHIPPED_VIEW,
                deliveryStatusCommand);

        // COMPLETED
        deliveryStatusCommand = new DeliveryStatusCommand(1, DeliveryStatus.COMPLETED);
        CommandParserTestUtil.assertParseSuccess(parser, " 1 " + CommandTestUtil.VALID_STATUS_COMPLETED_VIEW,
                deliveryStatusCommand);

        // CANCELLED
        deliveryStatusCommand = new DeliveryStatusCommand(1, DeliveryStatus.CANCELLED);
        CommandParserTestUtil.assertParseSuccess(parser, " 1 " + CommandTestUtil.VALID_STATUS_CANCELLED_VIEW,
                deliveryStatusCommand);
    ...
    public void parse_allFieldsExtraSpaceBetween_success() {
        DeliveryStatusCommand deliveryStatusCommand = new DeliveryStatusCommand(1, DeliveryStatus.CREATED);
        CommandParserTestUtil.assertParseSuccess(parser, "1    " + CommandTestUtil.VALID_STATUS_CREATED,
                deliveryStatusCommand);
    }
    ...
    public void parse_statusLowerCase_success() {
        ...
        CommandParserTestUtil.assertParseSuccess(parser, "1 " + CommandTestUtil.VALID_STATUS_CREATED_VIEW.toLowerCase(),
                deliveryStatusCommand);
    ...
    public void parse_statusUpperCase_success() {
        ...
        CommandParserTestUtil.assertParseSuccess(parser, "1 " + CommandTestUtil.VALID_STATUS_CREATED_VIEW.toUpperCase(),
                deliveryStatusCommand);
    ...
    public void parse_invalidStatus_failure() {
        CommandParserTestUtil.assertParseFailure(parser, "1 " + CommandTestUtil.INVALID_STATUS,
    ...
    public void parse_extraWordBeforeStatus_failure() {
        CommandParserTestUtil.assertParseFailure(parser, "1 word " + CommandTestUtil.INVALID_STATUS,
