...
public class DeliveryAddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        CommandParserTestUtil.assertParseSuccess(parser, CommandTestUtil.VALID_NAME_GABRIELS_MILK + CommandTestUtil.CUSTOMER_ID_DESC_MILK
                + CommandTestUtil.DELIVERY_DATE_DESC_MILK, new DeliveryAddCommand(expectedDescriptor));
    }

    @Test
    public void parse_missingPrefix_failure() {
        String expectedMessage = String.format(Messages.MESSAGE_INVALID_COMMAND_FORMAT, DeliveryAddCommand.MESSAGE_USAGE);
        // missing customer prefix
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.NAME_DESC_MILK + CommandTestUtil.VALID_CUSTOMER_ID_1
                + CommandTestUtil.DELIVERY_DATE_DESC_MILK, expectedMessage);

        // missing expected delivery date prefix
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.NAME_DESC_MILK + CommandTestUtil.CUSTOMER_ID_DESC_MILK
    ...
    public void parse_duplicatePrefix_failure() {
        ...
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.CUSTOMER_ID_DESC_MILK + CommandTestUtil.CUSTOMER_ID_DESC_MILK
                + CommandTestUtil.DELIVERY_DATE_DESC_MILK, expectedMessage);
    }
    ...
    public void parse_invalidArgs_throwsParseException() {
        ...
        // invalid name
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.INVALID_DELIVERY_NAME + CommandTestUtil.CUSTOMER_ID_DESC_MILK
                + CommandTestUtil.DELIVERY_DATE_DESC_MILK, DeliveryName.MESSAGE_CONSTRAINTS);

        // invalid format expected delivery date
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.VALID_NAME_GABRIELS_MILK + CommandTestUtil.CUSTOMER_ID_DESC_MILK
                + CommandTestUtil.INVALID_FORMAT_DELIVERY_DATE_DESC, DeliveryDate.MESSAGE_CONSTRAINTS);

        // invalid customer id
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.VALID_NAME_GABRIELS_MILK + CommandTestUtil.INVALID_CUSTOMER_ID_DESC
