...
public class DeliveryCreateNoteCommandParserTest {
    ...
    public void parse_allFieldsValid_success() {
        DeliveryCreateNoteCommand expectedCommand = new DeliveryCreateNoteCommand(1, new Note(CommandTestUtil.VALID_NOTE));
        CommandParserTestUtil.assertParseSuccess(parser, "1 " + PREFIX_NOTE + " " + CommandTestUtil.VALID_NOTE, expectedCommand);
    }
    ...
    public void parse_invalidNote_failure() {
        CommandParserTestUtil.assertParseFailure(parser, "1 " + PREFIX_NOTE + " " + CommandTestUtil.INVALID_NOTE, Note.MESSAGE_CONSTRAINTS);
    }

    @Test
    public void parse_missingNotePrefix_failure() {
        CommandParserTestUtil.assertParseFailure(parser, "1 " + CommandTestUtil.VALID_NOTE, MESSAGE_INVALID_FORMAT);
    }

    @Test
    public void parse_invalidIdNegative_failure() {
        CommandParserTestUtil.assertParseFailure(parser, "-1 " + PREFIX_NOTE + " " + CommandTestUtil.VALID_NOTE, MESSAGE_INVALID_FORMAT);
    }

    @Test
    public void parse_invalidIdNan_failure() {
        CommandParserTestUtil.assertParseFailure(parser, "NaN " + PREFIX_NOTE + " " + CommandTestUtil.VALID_NOTE, MESSAGE_INVALID_FORMAT);
    }

    @Test
    public void parse_missingId_failure() {
        CommandParserTestUtil.assertParseFailure(parser, PREFIX_NOTE + " " + CommandTestUtil.VALID_NOTE, MESSAGE_INVALID_FORMAT);
    }

    @Test
    public void parse_invalidOrder_failure() {
        CommandParserTestUtil.assertParseFailure(parser, PREFIX_NOTE + " " + CommandTestUtil.VALID_NOTE + " 1", MESSAGE_INVALID_FORMAT);
    }
}
